...
public class StepExecutionsJsonViewTests extends AbstractManagerViewTests {

	private final HashMap<String, Object> model = new HashMap<String, Object>();

	@Autowired
	@Qualifier("jobs/executions/steps.json")
	private View view;
	...
	public void testLaunchViewWithJobExecutionInfo() throws Exception {
		...
		model.put("stepExecutions", Arrays.asList(new StepExecutionInfo(MetaDataInstanceFactory.createStepExecution(),
		...
		assertEquals(0, wrapper.get("stepExecutions['1234'].commitCount"));
		assertEquals("http://localhost:8080/springsource/jobs/executions/123.json",
				wrapper.get("jobExecution.resource"));
	}
