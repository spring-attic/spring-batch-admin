...
<#assign company_url><@spring.messageText code="company.url" text=companyUrl!"https://www.spring.io"/></#assign>
<#assign company_name><@spring.messageText code="company.name" text=companyName!"Spring"/></#assign>
<#assign product_url><@spring.messageText code="product.url" text=productUrl!"https://projects.spring.io/spring-batch/"/></#assign>
